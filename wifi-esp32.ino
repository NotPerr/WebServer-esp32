...
// SSID & Password
const char* ssid = "醜八怪";
const char* password = "dalnim0404";
...
void setup() {
  ...
  pinMode(ledBri, OUTPUT);
  ledcSetup(0, 5000, 8);
  ledcAttachPin(ledBri, 0);
...
String htmlContent = "\
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column; align-items:center; background:#ccf2c9}\
         a { background: #6ab064; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
 ...
 <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column; align-items:center; background:#ccf2c9}\
        a { text-align:center; background: #6ab064; width: 100px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
      <h1>LED OPEN</h1>\
